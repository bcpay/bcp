...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to bcpay network</source>
        <translation>
            <numerusform>%n active connection to bcpay network</numerusform>
            <numerusform>%n active connections to bcpay network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bcpay_en.ts` remains unchanged.
